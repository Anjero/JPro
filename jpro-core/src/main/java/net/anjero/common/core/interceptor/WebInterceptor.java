package net.anjero.common.core.interceptor;


import net.anjero.common.core.ApplicationConstants;
import net.anjero.common.util.HttpUtils;
...
public class WebInterceptor implements HandlerInterceptor {
    private static org.slf4j.Logger log = LoggerFactory.getLogger(WebInterceptor.class);
