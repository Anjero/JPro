...
import net.anjero.common.spring.PropertyUtils;
...
public class ApplicationConstants {
    ...
    private static JProHelper jProHelper;


    public static JProHelper getjProHelper() {
        return jProHelper;
    }

    public static void setjProHelper(JProHelper jProHelper) {
        ApplicationConstants.jProHelper = jProHelper;
    }
...
//        return getValue("base.upload.path");
    ...
    public static String getFileSaveMainPath() {
        return getValue("photo.fileUploadPath");
    }
